        ...
        for nowtrial = 1:length(trialmat) %40
            ...
            if test_color == 0  % red
                if nowblocktype == 1  % red:up
                    if testspeed == 0.4 %down
                        sospeed = 5; % S0.6 (opposite to induction part)
                    elseif testspeed == 0.2
                        sospeed = 4; % S0.3
                    elseif testspeed == 0
                        sospeed = 3; % 0
                    elseif testspeed == -0.2
            ...
            if exist('CCMAEexp_slower.csv', 'file') ~= 2
            ...
            fid = fopen('CCMAEexp_slower.csv','at');
