function CCMAEexp_color_balanced_bothsides
...
try
    ...
    for nowblock = 1:length(blockmat)
        ...
        trialmat = repmat([0  -0.3;
            0   0;
            0   0.3;
            1  -0.3;
            1   0;
            1   0.3], 6, 1); %4,1
        trialorder = randperm(length(trialmat)); %=36
        ...
        for nowtrial = 1:length(trialmat) %40
            ...
            fid = fopen('CCMAEexp_color_balanced_bothsides.csv','at');
